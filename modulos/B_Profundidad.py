class Profundidad:
    ...
    def moverse(self):
        ...
        while pila:
            ...
            if p_actual==(self.posS_x, self.posS_y): #El -1 indica la ultima posición de la pila, es decir la posicion de la meta
                print("Solución encontrada usando el algoritmo de busqueda en profundidad")
                self.camino()
